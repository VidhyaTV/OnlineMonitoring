...
public class RunningParameters implements Serializable{
	...
	*/
	public final long localVariableTrueIntervalLength;
	...
	public RunningParameters( int numberOfMembers,
							  ...
							  long localVariableTrueIntervalLength,
							  long epsilon,
		 ...
		 */
		this.localVariableTrueIntervalLength = localVariableTrueIntervalLength;
		...
		if(causalityClockString.startsWith("hvc")) {	
			...
			System.out.println("Warning unknown causality clock option: use hlc as a default.");
			this.timestampType = TimestampType.HLC;
		}
  ...
  public RunningParameters(RunningParameters p) {
	   ...
	   */
	   this.localVariableTrueIntervalLength = p.localVariableTrueIntervalLength;
